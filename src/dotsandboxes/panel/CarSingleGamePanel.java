...
public class CarSingleGamePanel extends SingleGamePanel {
     /**
	 * 
	 */
	...
	public CarSingleGamePanel(){	
	  ...
	  //设置总背景
	    ...
	    //
	    JLabel name1 =new JLabel(new ImageIcon("images/car/me.png"));
	    name1.setBounds(135,1,105,55);	    	    	
	    wholeBG.add(name1);
	    //
	    JLabel name2 =new JLabel(new ImageIcon("images/car/computer.png"));
	    name2.setBounds(550,1,105,55);	    
	    wholeBG.add(name2);
	    //
	  
	    up.setBounds(640,210,150,50);
    	...
    	scoreplayer1[0].setBorderPainted(false);
    	scoreplayer1[0].setContentAreaFilled(false);
    	scoreplayer1[0].setFocusPainted(false);
	    ...
	    for(i=1;i<=11;i++){
	    	...
	    	scoreplayer1[i].setBorderPainted(false);
	    	scoreplayer1[i].setContentAreaFilled(false);
	    	scoreplayer1[i].setFocusPainted(false);
    	...
    	scoreplayer1[12].setBorderPainted(false);
    	scoreplayer1[12].setContentAreaFilled(false);
    	scoreplayer1[12].setFocusPainted(false);
    	...
    	scoreplayer2[0].setBounds(3, 5+(0-6)*(0-6)*2, 10, 20);
    	scoreplayer2[0].setOpaque(true);
    	scoreplayer2[0].setVisible(true); 
    	scoreplayer2[0].setEnabled(true);
    	scoreplayer2[0].setBorderPainted(false);
    	scoreplayer2[0].setContentAreaFilled(false);
    	scoreplayer2[0].setFocusPainted(false);
	    ...
	    for(j=1;j<12;j++){
	    	...
	    	scoreplayer2[j].setBounds(j*15, 5+(j-6)*(j-6)*2, 10, 20);
	    	scoreplayer2[j].setOpaque(true);
	    	scoreplayer2[j].setVisible(true); 
	    	scoreplayer2[j].setEnabled(true);
	    	scoreplayer2[j].setBorderPainted(false);
	    	scoreplayer2[j].setBorderPainted(false);
	    	scoreplayer2[j].setContentAreaFilled(false);
    	...
    	scoreplayer2[12].setBounds(12*15-3, 5+(0-6)*(0-6)*2, 10, 20);
    	scoreplayer2[12].setOpaque(true);
    	scoreplayer2[12].setVisible(true); 
    	scoreplayer2[12].setEnabled(true);
    	scoreplayer2[12].setBorderPainted(false);
    	scoreplayer2[12].setBorderPainted(false);
    	scoreplayer2[12].setContentAreaFilled(false);
