...
public class CatSingleGamePanel extends SingleGamePanel{
    ...
    up.setBounds(230,590,120,50);
    up.setContentAreaFilled(false);
    up.setBorderPainted(false);
    gameBackGround.add(up);

    down.setBounds(430,590,120,50);
    down.setContentAreaFilled(false);
    down.setBorderPainted(false);
    gameBackGround.add(down);
